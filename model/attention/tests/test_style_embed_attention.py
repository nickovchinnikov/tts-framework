...
class TestStyleEmbedAttention(unittest.TestCase):
    def test_output_shape(self):
        ...
        query = torch.rand(5, 10, 16)  # batch of 5, 10 queries per batch, each of size 16
        key = torch.rand(5, 20, 16)  # batch of 5, 20 key-value pairs per batch, each of size 16
