...
class TestPitchAdaptor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pitch_adaptor = PitchAdaptor(model_config, "./model/acoustic_model/tests/mocks")
    ...
    def test_add_pitch_train(self):
        ...
        out, pitch_prediction, pitch_embedding_true, pitch_embedding_pred = self.pitch_adaptor.add_pitch_train(
