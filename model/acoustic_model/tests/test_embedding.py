...
class TestEmbedding(unittest.TestCase):
    ...
    def setUp(self):
        self.embedding = Embedding(num_embeddings=100, embedding_dim=50)

    def test_forward_output_shape(self):
        # Generate a tensor of indices to lookup in the embedding
        idx = torch.randint(low=0, high=100, size=(10, 20))  # for a sequence of length 20 and batch size 10
    ...
    def test_dtype(self):
        idx = torch.randint(low=0, high=100, size=(10, 20))  # some example indices
