...
def average_over_durations(values: torch.Tensor, durs: torch.Tensor) -> torch.Tensor:
    r"""
    This function calculates the average of values over specified durations.
...
class EnergyAdaptor(nn.Module):
    ...
    def get_energy_embedding_train(
        ...
        r"""
        This function is used during training to get the energy prediction, average energy target, and energy embedding.
    ...
    def get_energy_embedding(self, x: torch.Tensor, mask: torch.Tensor, energy_transform: Callable) -> Tuple[torch.Tensor, torch.Tensor]:
        r"""
        This function is used during inference to get the energy embedding and energy prediction.
