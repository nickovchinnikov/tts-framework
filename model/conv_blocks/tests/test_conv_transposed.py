...
class TestConvTransposed(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertIsInstance(conv_transposed.conv, BSConv1d,
        ...
        self.assertEqual(conv_transposed.conv.pointwise.conv.in_channels, C_in,
                         msg=f"Expected conv.pointwise.conv.in_channels to be {C_in}, got {conv_transposed.conv.pointwise.conv.in_channels}")
        
        self.assertEqual(conv_transposed.conv.pointwise.conv.out_channels, C_out,
        ...
        self.assertEqual(conv_transposed.conv.depthwise.conv.kernel_size[0], kernel_size,
                         msg=f"Expected conv.depthwise.conv.kernel_size[0] to be {kernel_size}, got {conv_transposed.conv.depthwise.conv.kernel_size[0]}")
        
        self.assertEqual(conv_transposed.conv.depthwise.conv.padding[0], padding,
