...
class TestConv1dGLU(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertIsInstance(conv_glu.bsconv1d, BSConv1d,
                              msg="Expected bsconv1d attribute to be instance of BSConv1d Layer")
        self.assertIsInstance(conv_glu.bsconv1d.pointwise, PointwiseConv1d,
                              msg="Expected bsconv1d.pointwise to be instance of PointwiseConv1d")
        self.assertIsInstance(conv_glu.bsconv1d.depthwise, DepthWiseConv1d,
                              msg="Expected bsconv1d.depthwise to be instance of DepthWiseConv1d")
        self.assertIsInstance(conv_glu.embedding_proj, nn.Linear,
    ...
    def test_output_shape(self):
        ...
        """
        batch_size, sequence_length, d_model, kernel_size, padding, embedding_dim = 64, 50, 8, 3, 1, 16
        conv_glu = Conv1dGLU(d_model, kernel_size, padding, embedding_dim)
