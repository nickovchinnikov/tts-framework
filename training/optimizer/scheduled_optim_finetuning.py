...
class ScheduledOptimFinetuning:
    def __init__(
        ...
        r"""
        Initializes a ScheduledOptimFinetuning optimizer.

        Args:
            parameters (Iterable): Iterable of model parameters to optimize.
            train_config (AcousticFinetuningConfig): Configuration object for the optimizer.
    ...
    def step_and_update_lr(self, step: int) -> None:
        r"""
        Updates the learning rate and takes a step of the optimizer.
    ...
    def _get_lr_scale(self) -> float:
        r"""
        Computes the learning rate scale factor.
